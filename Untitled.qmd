...
```{r}
gs4_get("https://docs.google.com/spreadsheets/d/1sKr_IVYbZ_Rvjwb-J1ioXKiYw3lKBfTP6qJ-7Z9GErM/edit#gid=2146667779")
yugie <- range_read(bills, sheet = 4)
...
for (i in seq_along(names)){
  names[i] <- read_sheet(bills, sheet = 4)
}
